...
At Unbound3D Slicer (forked from OrcaSlicer), we are committed to maintaining the security of our ecosystem. Our policy is to ensure that we do not introduce vulnerabilities and that any security issues are addressed promptly and responsibly. We appreciate your help in improving the security of Unbound3D Slicer and thank you for your responsible disclosure.
...
## To report a security bug, please follow these guidelines:
  ...
  * Handling the Report:
        Unbound3D Slicer will confirm the problem and determine the affected versions.
...
To enhance security when using Unbound3D Slicer, we recommend following these steps:
...
### Thank you for your commitment to the security of Unbound3D Slicer. Your efforts help us maintain a safe and reliable ecosystem.
