...
static const std::string VERSION_CHECK_URL = "https://check-version.unbound3d.com/latest";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/Unbound3D/unbound3d-slicer-profiles/releases/tags";
