...
#define SLIC3R_APP_FULL_NAME "Unbound3D Slicer"
#define GCODEVIEWER_APP_NAME "Unbound3D-slicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "Unbound3DSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("Unbound3D-slicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
