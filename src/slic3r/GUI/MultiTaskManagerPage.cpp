    ...
    m_task_type(type)
{
    ...
    StateColor clean_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(42, 42, 42), StateColor::Enabled));
    StateColor clean_text(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(42, 42, 42), StateColor::Enabled));
            ...
            if (state_cloud_task == 0 && m_job_id == get_obj()->profile_id_) {
                ...
                else if (state_device == 2)
                {
                    ...
                    if (obj_->get_curr_stage() == _L("Printing") && obj_->subtask_) {
                        ...
                        dc.SetPen(wxPen(wxColour(51, 51, 51)));
                        dc.SetBrush(wxBrush(wxColour(51, 51, 51)));
