...
static const wxColour BUTTON_HOVER_COL   = wxColour(51, 51, 51);
...
static const wxColour STAGE_TEXT_COL      = wxColour(51, 51, 51);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(51, 51, 51));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(51, 51, 51));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(51, 51, 51));
        });
...
wxBoxSizer* StatusBasePanel::create_filament_group(wxWindow* parent)
{
    ...
    m_title_filament_loading->SetForegroundColour(wxColour(34, 34, 34));
