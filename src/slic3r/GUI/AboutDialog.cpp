...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Unbound3D Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Unbound3D Slicer is based on OrcaSlicer, PrusaSlicer and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    text_list.push_back(_L("Unbound3D Slicer is a fork of OrcaSlicer, which began in a spirit of collaboration, drawing from PrusaSlicer, BambuStudio, SuperSlicer, and CuraSlicer. OrcaSlicer introduced advanced calibration tools, precise wall and seam control and hundreds of other features."));
    text_list.push_back(_L("Unbound3D Slicer continues that tradition, building on OrcaSlicer's foundation to deliver the best possible slicing experience."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2026 Unbound3D. All Rights Reserved", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#009789\" href=\"https://www.unbound3d.com\">https://www.unbound3d.com</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
