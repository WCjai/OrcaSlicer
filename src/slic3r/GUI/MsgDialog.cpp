                            ...
                            std::function<void(const wxString &)> link_callback = nullptr)
{
    ...
    if (!link_text.IsEmpty() && link_callback) {
        msg_escaped += "<span><a href=\"#\" style=\"color:rgb(51, 51, 51); text-decoration:underline;\">" + std::string(link_text.ToUTF8().data()) + "</a></span>";
    }
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is in Beta and it is newer than the current Unbound3D Slicer version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Unbound3D Slicer Beta, you may click to"));
        // ORCA standardized HyperLink
        HyperLink *      github_link = new HyperLink(this, _L("Download Beta Version"), "https://github.com/Unbound3D/Unbound3D-slicer/releases");
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
        horizontal_sizer->Add(github_link, 0, wxEXPAND | wxLEFT, 5);
        
    } else {
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is newer than the current Unbound3D Slicer version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Updating your Unbound3D Slicer could enable all functionality in the 3MF file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
