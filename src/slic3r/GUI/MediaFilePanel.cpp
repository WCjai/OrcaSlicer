    ...
    , m_machine("<null>")
{
    ...
    for (auto b : {m_button_year, m_button_month, m_button_all}) {
        ...
        b->SetTextColor(StateColor(
            std::make_pair(0x2A2A2A, (int) StateColor::Checked),
    ...
    m_button_management->SetBackgroundColorNormal(wxColor("#333333"));
    m_button_management->SetTextColorNormal(*wxWHITE);
    m_button_management->Enable(false);
    m_button_refresh->SetBorderWidth(0);
    m_button_refresh->SetBackgroundColorNormal(wxColor("#333333"));
            ...
            if (index != -1) {
                ...
                fs->FetchModel(index, [this, fs, dlg, index](int result, std::string const &data) {
                    ...
                    if (gcode_file_count > 0) {
                        ...
                        MessageDialog dlg(this, _L("The .gcode.3mf file contains no G-code data. Please slice it with Unbound3D Slicer and export a new .gcode.3mf file."),
