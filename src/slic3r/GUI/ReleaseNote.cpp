    ...
    : DPIDialog(static_cast<wxWindow*>(wxGetApp().mainframe), wxID_ANY, _L("Network plug-in update"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    operation_tips = new ::Label(this, Label::Body_12, _L("Click OK to update the Network plug-in when Unbound3D Slicer launches next time."), LB_AUTO_WRAP);
...
UpdateVersionDialog::UpdateVersionDialog(wxWindow *parent)
    : DPIDialog(parent, wxID_ANY, _L("New version of Unbound3D Slicer"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER)
{
    SetBackgroundColour(*wxWHITE);
 ...
 //    m_vebview_release_note->LoadURL(from_u8(url));
    ...
    stable_only_label->SetForegroundColour(wxColour(42, 42, 42));
...
void ConfirmBeforeSendDialog::edit_cancel_button_txt(const wxString& txt, bool switch_green)
{
    ...
    if (switch_green)
    {
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(34, 34, 34), StateColor::Pressed),
                                std::pair<wxColour, int>(wxColour(85, 85, 85), StateColor::Hovered),
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    comfirm_before_enter_text = _L("1. Please confirm Unbound3D Slicer and your printer are in the same LAN.");
    ...
    m_test_right_msg->SetForegroundColour(wxColour(85, 85, 85));
