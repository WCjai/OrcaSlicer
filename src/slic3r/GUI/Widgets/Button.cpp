    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x888888, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0x333333, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#333333", "#333333"};
wxString btn_confirm[10]  = {"#DFDFDF", "#333333", "#555555", "#333333", "#333333", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#444444", "#FFFFFF"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#333333", "#333333"};
