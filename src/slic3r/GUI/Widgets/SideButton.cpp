    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(34, 34, 34), StateColor::Pressed);
    border_color.append(wxColour(85, 85, 85), StateColor::Hovered);
    border_color.append(0x333333, StateColor::Normal);
    ...
    background_color.append(wxColour(34, 34, 34), StateColor::Pressed);
    background_color.append(wxColour(85, 85, 85), StateColor::Hovered);
    background_color.append(0x333333, StateColor::Normal);
    background_color.setTakeFocusedAsHovered(false);

    SetBottomColour(wxColour("#2A2A2A"));
